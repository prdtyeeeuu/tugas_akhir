...
const { portfolioImage } = require('../middleware/upload');
...
// Portfolios
router.post('/portfolios/add', portfolioImage.single('portfolioImage'), profileStructuredController.addPortfolio);
router.put('/portfolios/:id', portfolioImage.single('portfolioImage'), profileStructuredController.updatePortfolio);
